...
class OpenIE:
    ...
    def save_results(self, results: Dict[str, Any], output_dir: str = "."):
        ...
        with open(os.path.join(output_dir, f"openie_results_{self.model_name}.json"), 'w', encoding='utf-8') as f:
            json.dump(json_results, f, indent=2, ensure_ascii=False)
        
        logger.info(f"Results saved to {output_dir}/openie_results_{self.model_name}.json")
