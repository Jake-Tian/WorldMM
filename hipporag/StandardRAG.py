...
class StandardRAG:
    ...
    def rag_qa(self,
        ...
        if gold_answers is not None:
            ...
            logger.warning("QA evaluators are not available. Evaluation skipped.")
            pass
    ...
    def qa(self, queries: List[QuerySolution]) -> Tuple[List[QuerySolution], List[str], List[Dict]]:
        ...
        all_qa_results = [generate_text_response(qa_messages, model=self.global_config.llm_name) for qa_messages in tqdm(all_qa_messages, desc="QA Reading")]

        all_response_message, all_metadata = zip(*all_qa_results)
    ...
    def get_query_embeddings(self, queries: List[str] | List[QuerySolution]):
        ...
        if len(all_query_strings) > 0:
            ...
            query_embeddings_for_passage = self.embedding_model.encode(all_query_strings,
